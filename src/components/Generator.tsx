...
export default () => {
  ...
  const handleButtonClick = async () => {
    ...
    setMessageList([
      ...
      {
        role: 'assistant',
        content: 'Thank you for considering me for the position. I have over 5 years of experience as a professional cover letter writer, and I have helped many clients land their dream jobs. I would love to work with you to create a cover letter that showcases your unique skills and experiences. Please let me know if you have any questions or if you would like to schedule a consultation.',
      },
    ])
